...
import Bassi_03_02 as k02  # This module is for plotting components
...
class WidgetsWindow(tk.Tk):
    def __init__(self):
        ...
        self.center_frame.rowconfigure(0, weight=1, uniform='xx')
...
widgets_window.title('Assignment_03 --  Bassi')
